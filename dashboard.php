...
<body class="bg-slate-100">
  ...
  <header>
    <button @click="open = !open" @click.away="open = false" class="flex items-center space-x-2 focus:outline-none mr-5">
    ...
    <div x-show="open" x-transition class="absolute right-0 w-48 mt-2 py-1 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-10 ml-5">
